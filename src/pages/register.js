...
<div className='font-black-ops-one text-white text-5xl items-center lg:h-screen '>
BLITZSCHLAG
</div>
<div className=' bg-black opacity-80 backdrop-blur-md w-96 lg:w-[350px] rounded-lg p-8'>
