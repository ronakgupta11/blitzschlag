...
const index = () => {
  return (
    ...
    >
      <div
        className="flex  align-middle flex-wrap mt-[100px] gap-[50px]  items-center justify-center flex-shrink-0 w-952 h-74"
        style={{}}
      >
        <Image src={colorLine} ></Image>
        <div
          className="text-center  font-BlackOpsOne text-[36px] md-text-[34] lg:text-[64px] font-normal leading-[40px]"
          style={{
            background:
