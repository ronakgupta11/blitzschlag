...
function Page2() {
  ...
  return (
    <div className='h-[700px] md:h-screen w-full relative flex flex-col items-center overflow-hidden' style={{ background: "linear-gradient(180deg, #E6745A -7.87%, #FFBCB6 74.4%)"}}>
