...
function Page5() {
  ...
  return (
    <div className='h-[700px] sm:h-screen w-full relative flex flex-col items-center overflow-hidden' style={{ background:" linear-gradient(180deg, #292929 -7.2%, #5F5F5F 79.53%)"}}>
