...
function Page3() {
  ...
  return (
    <div className='h-[700px] md:h-screen w-full relative flex flex-col  items-center overflow-hidden' style={{ background: "linear-gradient(180deg, #5DAAE7 -7.87%, #BEEBFF 74.4%)"}}>


<div className='self-start mt-12 ml-4'>

<p className=' text-transparent bg-clip-text font-sankaran text-5xl md:text-7xl  'style={{background: "#0D2138"}}>Events</p>
<button className='btn z-20 px-12 mt-12 text-white' style={{
   background: '#0D2138', boxShadow: '0px 6px 14.899999618530273px rgba(102, 179, 215, 0.80)', borderRadius: 20
        ...
        <Image  className='w-[300px] absolute left-[20%] top-[20%] z-0' src={moon}/>
