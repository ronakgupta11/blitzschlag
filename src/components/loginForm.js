...
<label className="form-control w-full max-w-xs">
  ...
  <input type="text" placeholder="blitzschlag@gmail.com" onChange={(e)=>{
            dispatch(CLEAR_ERRORS())
...
<label className="form-control w-full max-w-xs">
  ...
  <input type="password" placeholder="Type Here.." onChange={(e)=>{
            dispatch(CLEAR_ERRORS())
...
<div className='flex  items-center space-x-5 justify-between px-4 text-white'>
    <Link className='  text-sm' href={"/register"}>Create an account</Link>
